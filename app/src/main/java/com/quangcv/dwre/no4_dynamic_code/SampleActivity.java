package com.quangcv.dwre.no4_dynamic_code;
...
import com.quangcv.app.LibraryInterface;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        v.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                lib.sayHi(SampleActivity.this, "Developer");
            }
        });
        setContentView(v);
    }

    void prepareDex(final File output) {
        if (output.exists()) {
            return;
        }
